    ...
    useEffect(() => {
        async function buscarDetalhesUsuario() {
            ...
            try {
                ...
                console.log("AAAAAAAAAAAAAAAAABBBBBBBBB");
                console.log(usuario);
                setNome(usuario.usuario.nome);
                setIdade(usuario.usuario.idade);
                setDescricao(usuario.usuario.descricao);
                setTipo(usuario.usuario.tipo);
                setImagem(usuario.usuario.imagem);
                setAvatar(usuario.usuario.avatar);
